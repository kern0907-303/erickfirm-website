  ...
  'zh-TW': {
    ...
    cards: [
      ...
      },
      {
        id: '03',
        title: 'ＡＢＬ量子調頻',
        problem: '個人成長專案：透過 TimeWaver 分析找到核心問題',
    ...
    cards: [
      {
        id: '01',
        title: 'I8 Enterprise',
        problem: 'Enterprise Doctor: Fix stagnant revenue and team friction',
        outcome: 'Restore a predictable operating rhythm and scalable execution',
        to: '/insights/enterprise-doctor',
        cta: 'Explore I8 Enterprise',
      },
      {
        id: '02',
        title: 'NAS Life Numerology',
        problem: 'Life Blueprint: Fix decision confusion and role mismatch',
        outcome: 'Clarify decision logic and team roles to reduce repeated friction',
        to: '/insights/life-number',
        cta: 'Explore NAS Life Numerology',
      },
      {
        id: '03',
        title: 'ABL Quantum Frequency',
        problem: 'Personal Growth: TimeWaver-based core issue analysis',
