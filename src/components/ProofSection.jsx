...
const copy = {
  'zh-TW': {
    ...
    steps: [
      ...
      { title: '服務對位', desc: '依照你的情境，對應到 Ｉ８企業、ＮＡＳ生命數字或 ＡＢＬ量子調頻服務軌道。' },
  ...
  en: {
    ...
    steps: [
      ...
      { title: 'Match the Service', desc: 'Map your scenario to the I8 Enterprise, NAS Life Numerology, or ABL Quantum Frequency service tracks.' },
