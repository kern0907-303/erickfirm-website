...
const copy = {
  'zh-TW': {
    ...
    services: [
      ...
      { id: '02', title: '生命數字', audience: '方向混亂、角色多重、常在關鍵時刻卡住決策的人', solve: '決策反覆、角色錯位、溝通誤解與合作磨耗', method: '決策偏好盤點 → 角色對位分析 → 情境策略建議 → 週期校正', outcome: '看清自己的決策模式，讓選擇更快更穩，合作更順暢', timeline: '通常 1-3 週可看到決策清晰度與溝通效率改善', path: '/insights/life-number' },
