...
const copy = {
  'zh-TW': {
    ...
    items: [
      ...
      {
        q: '我不知道該做什麼，誰可以幫我分析？',
        a: '先做生命藍圖規劃的決策偏好與角色對位分析，釐清你現在該先做哪一件事、該先放下哪一件事。',
  ...
  en: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Start with Life Blueprint Planning to map decision preference and role alignment, then define what to do first and what to pause.',
        to: '/insights/life-number',
