...
const copy = {
  'zh-TW': {
    ...
    items: [
      {
        q: '如何打破企業營收增長停滯的瓶頸？',
        a: '增長的本質是交易流程的無阻礙運轉。如果營收停滯，並非團隊不夠努力，而是商業漏斗出現阻塞。初八企業顧問 I8 協助您精確盤點「獲客-交付-回款」三段結構，排除內部損耗。',
        to: '/insights/enterprise-doctor',
        cta: '探索 I8 企業醫生專案',
      },
      {
        q: '我想提升決策力與執行力，卻總是面臨隱形阻力？',
        a: '執行阻力源於身心過載與狀態卡點。當您意志力強撐依然感到拖延或疲耗，代表底層狀態需要被重新支持與對位。艾伯林 ABL 協助您定位核心阻力源，將硬撐轉化為穩定的自然動力。',
        to: '/insights/personal-growth',
        cta: '探索 ABL 個人狀態對位專案',
      },
      {
        q: '團隊內耗高、合作高摩擦，該如何理清關係？',
        a: '合作與關係的摩擦本質上是角色定位與決策偏好的錯位。平衡空間 NAS 協助您與合夥團隊進行深度生命藍圖與權力分工對位，讓對的權力回到對的位置，將溝通摩擦降到最低。',
  ...
  en: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Persistent hesitation stems from state overcapacity. ABL Personal Alignment isolates and clears execution blockages, restoring decision performance.',
        to: '/insights/personal-growth',
        cta: 'Explore ABL Personal Alignment',
      },
      {
