...
const copy = {
  'zh-TW': {
    ...
    cards: [
      ...
      ['生命數字決策地圖', '快速判斷你在壓力情境下的決策偏差與溝通盲點。', '/insights/life-number', '查看地圖 →'],
  ...
  en: {
    ...
    cards: [
      ...
      ['Numerology Decision Map', 'Spot decision bias and communication blind spots under pressure.', '/insights/life-number', 'Open Map →'],
