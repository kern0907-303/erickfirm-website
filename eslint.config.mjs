...
export default [
	{ ignores: ['node_modules/**', 'dist/**', 'build/**', 'vite.config.js', '.netlify/**'] },
	{
		files: ['**/*.js', '**/*.jsx'],
	...
	{ files: ['tools/**/*.js', 'scripts/**/*.js', 'tailwind.config.js', 'netlify/functions/**/*.js'], languageOptions: { globals: globals.node } },
];
